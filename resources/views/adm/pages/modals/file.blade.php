    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_file" method="POST" enctype="multipart/form-data" action="{{route('pages.file.upload',['id'=>$page->id])}}">
                    @csrf
                    <div class="form-group">
                        <label for="pageFile">Arquivo:</label>
                        <input id="pageFile" type="file" name="pageFile" class="form-control" onchange="validateFile()">
                    </div>
                    <div class="form-group">
