    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_photo" method="POST" enctype="multipart/form-data" action="{{route('pages.photo.upload',['id'=>$page->id])}}">
                    @csrf
                    <div class="form-group">
                        <label for="pagePhoto">Arquivo:</label>
                        <input id="pagePhoto" type="file" accept="image/*" name="pagePhoto" class="form-control" onchange="validatePhoto()">
                    </div>
                    <div class="form-group">
